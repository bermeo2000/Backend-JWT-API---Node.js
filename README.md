...
Este proyecto es una API REST desarrollada con Node.js y Express que implementa autenticación mediante JSON Web Token (JWT).
Permite registrar usuarios, iniciar sesión y gestionar usuarios utilizando una base de datos MySQL mediante Sequelize.
